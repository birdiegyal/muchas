...
export default function ProfileCard({ closeModal }) {
  ...
  return (
    <ClickAwayListener onClickAway={handleClickAway}>
      <div className="absolute bottom-2  rounded-md left-1/2 flex flex-col -translate-x-1/2 max-h-[12%]  bg-transparent min-w-[97%] sm:min-w-[50%] backdrop-blur-3xl backdrop-brightness-90 popup">
        ...
        <div className="w-[100%]  transparent">
          <div className="flex  shadow-xl rounded-lg py-3">
